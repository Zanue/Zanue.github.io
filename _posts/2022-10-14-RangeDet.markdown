...
1. **For weight acquisition**, denote the positional relationship vector as $\mathbf{h}(\mathbf{p}_0, \mathbf{p}_n)$, the convolution weight $\mathbf{W}_{\mathbf{p}_0}(\mathbf{p}_n)$ is: <br/>
    $$
